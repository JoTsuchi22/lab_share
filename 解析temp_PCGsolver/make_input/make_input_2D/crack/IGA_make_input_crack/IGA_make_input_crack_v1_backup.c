...
void Make_patch_file(int num)
{
    ...
    else if (num == 40)
    {
        ...
        b = 0.0;
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 1, rot(a, b, 0), rot(a, b, 1), 1.0);
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 2, crack_tip[0] + length_each_side[0], crack_tip[1] - singular_width, 1.0);
        a = global_length[0] / 2.0;
        b = (global_length[1] / 2.0) * (cp_after_each_side[2]) / (cp_after_each_side[2] + singular_width);
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 3, rot(a, b, 0), rot(a, b, 1), 1.0);
    }
    else if (num == 41)
    {
    ...
    else if (num == 42)
    {
        ...
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 1, rot(a, b, 0), rot(a, b, 1), 1.0);
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 2, crack_tip[0] + length_each_side[0], crack_tip[1] + singular_width, 1.0);
        a = (global_length[0] / 2.0) * (cp_after_each_side[2]) / (cp_after_each_side[2] + singular_width);
        b = global_length[1] / 2.0;
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 3, rot(a, b, 0), rot(a, b, 1), 1.0);
    }
    else if (num == 43)
    ...
    else if (num == 44)
    {
        ...
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 1, rot(a, b, 0), rot(a, b, 1), 1.0);
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 2, crack_tip[0] + singular_width, crack_tip[1] + length_each_side[2], 1.0);
        a = - (global_length[0] / 2.0) * (cp_after_each_side[0]) / (cp_after_each_side[0] + cp_after_each_side[1] + 2 * singular_width);
        b = global_length[1] / 2.0;
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 3, rot(a, b, 0), rot(a, b, 1), 1.0);
    }
    else if (num == 45)
    {
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 0, crack_tip[0] + singular_width, crack_tip[1] + length_each_side[2], 1.0);
        a = - (global_length[0] / 2.0) * (cp_after_each_side[0]) / (cp_after_each_side[0] + cp_after_each_side[1] + 2.0 * singular_width);
        b = global_length[1] / 2.0;
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 1, rot(a, b, 0), rot(a, b, 1), 1.0);
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 2, crack_tip[0], crack_tip[1] + length_each_side[2], 1.0);
        a = - (global_length[0] / 2.0) * (cp_after_each_side[0] + singular_width) / (cp_after_each_side[0] + cp_after_each_side[1] + 2.0 * singular_width);
        b = global_length[1] / 2.0;
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 3, rot(a, b, 0), rot(a, b, 1), 1.0);
    }
    else if (num == 46)
    {
        ...
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 1, rot(a, b, 0), rot(a, b, 1), 1.0);
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 2, crack_tip[0] - singular_width, crack_tip[1] + length_each_side[2], 1.0);
        a = - (global_length[0] / 2.0) * (cp_after_each_side[0] + 2.0 * singular_width) / (cp_after_each_side[0] + cp_after_each_side[1] + 2.0 * singular_width);
        b = global_length[1] / 2.0;
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 3, rot(a, b, 0), rot(a, b, 1), 1.0);
    }
    else if (num == 47)
    ...
    else if (num == 48)
    {
        ...
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 2, - crack_tip[0] + singular_width, crack_tip[1] + length_each_side[2], 1.0);
        a = - global_length[0] / 2.0;
        b = (global_length[1] / 2.0) * (cp_after_each_side[0] + 2.0 * singular_width) / (cp_after_each_side[0] + cp_after_each_side[1] + 2.0 * singular_width);
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 3, rot(a, b, 0), rot(a, b, 1), 1.0);
    }
    else if (num == 49)
    {
        ...
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 2, - crack_tip[0], crack_tip[1] + length_each_side[2], 1.0);
        a = - global_length[0] / 2.0;
        b = (global_length[1] / 2.0) * (cp_after_each_side[0] + singular_width) / (cp_after_each_side[0] + cp_after_each_side[1] + 2.0 * singular_width);
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 3, rot(a, b, 0), rot(a, b, 1), 1.0);
    }
    else if (num == 50)
    {
        ...
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 2, - crack_tip[0] - singular_width, crack_tip[1] + length_each_side[2], 1.0);
        a = - global_length[0] / 2.0;
        b = (global_length[1] / 2.0) * (cp_after_each_side[0]) / (cp_after_each_side[0] + cp_after_each_side[1] + 2.0 * singular_width);;
        fprintf(fp, "%d   %.17e   %.17e   %.17e\n", 3, rot(a, b, 0), rot(a, b, 1), 1.0);
    }
    else if (num == 51)
    {
