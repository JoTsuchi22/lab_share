...
void KI_cp_2D(int insert_parameter_axis);
// Order Elevation
...
void Bezier_Order_Elevation_2D(int elevation_parameter_axis, int Bezier_line_number);
...
void Calc_Bezier_2D(int elevation_parameter_axis, int other_axis);
...
void KR_reset_array();
void KR_non_uniform_2D(int removal_parameter_axis);
void OE_2D(int elevation_parameter_axis);
// Output
