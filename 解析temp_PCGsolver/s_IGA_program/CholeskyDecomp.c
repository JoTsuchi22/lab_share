...
int main()
{
    ...
    double ld[10][10], KK1[10][10], KK2[10][10];
    for (i = 0; i < 10; i++)
    {
        for (j = 0; j < 10; j++)
        {
    ...
    for (i = 0; i < 10; i++)
    {
        for (j = 0; j < 10; j++)
        {
            for (k = 0; k < 10; k++)
            {
                KK2[i][j] += KK1[i][k] * ld[j][k];
            }
        }
    }


    printf("L d^(1/2) AA d^(1/2)T L^T\n\n");
    for (i = 0; i < 10; i++)
    {
        for (j = 0; j < 10; j++)
        {
