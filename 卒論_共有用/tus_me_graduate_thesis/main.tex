...
% \documentclass[12pt,a4j,oneside,titlepage,draft,fleqn]{jsbook} % 画像の出力を省略
%
%% パッケージ
...
\begin{titlepage}
 ...
 \begin{center}
  ...
  {２０２１年度卒業論文} \\[2\baselineskip]
  {\Large IGA-重合パッチ法(S-IGA)の基底関数の高次化に関する研究} \\[9\baselineskip]
  {２０２２年２月} \\[2\baselineskip]
  {東京理科大学理工学部機械工学科} \\[\baselineskip]
  {岡田研究室} \\[3\baselineskip]
  {７５１８０７４　　土山　雄飛}
 \end{center}
\end{titlepage}
}
